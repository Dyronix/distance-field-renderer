...
namespace rex
{
    namespace opengl
    {
        ...
        void Texture2D::assign_filter(const Filter& filter)
        {
            ...
            {
            case Texture::Filter::Action::MINIFICATION: opengl::set_texture_integer_parameter(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, type); m_min_filter = filter.type; break;
            case Texture::Filter::Action::MAGNIFICATION: opengl::set_texture_integer_parameter(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, type); m_mag_filter = filter.type; break;
            }
        }
        //-------------------------------------------------------------------------
        void Texture2D::assign_wrap(const Wrap& wrap)
        {
            ...
            case Texture::Wrap::Coordinate::WRAP_S: opengl::set_texture_integer_parameter(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, type); m_wrap_s = wrap.type; break;
            case Texture::Wrap::Coordinate::WRAP_T: opengl::set_texture_integer_parameter(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, type); m_wrap_t = wrap.type; break;
            }
        }
    }
}