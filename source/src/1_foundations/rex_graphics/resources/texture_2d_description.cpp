    ...
    Texel::Format get_texel_format(Texture::Format textureFormat)
    {
        switch(textureFormat)
        {
            ...
            case Texture::Format::DEPTH_COMPONENT_32_FLOAT: 
                return Texel::Format::DEPTH_COMPONENT;
            ...
            case Texture::Format::DEPTH_COMPONENT_32_FLOAT_STENCIL_8_FLOAT: 
                return Texel::Format::DEPTH_STENCIL_COMPONENT;

            default:
                R_ASSERT_X(false, "Unsupported Texture Format");
                return Texel::Format::UNKNOWN;
        }
    }
