...
namespace sbt
{
    ...
    public:
        ...
        PoolIt                          begin() { return m_framebuffer_pool.begin(); }
        ConstPoolIt                     cbegin() const { return m_framebuffer_pool.cbegin(); }
        PoolIt                          end() { return m_framebuffer_pool.end(); }
        ConstPoolIt                     cend() const { return m_framebuffer_pool.cend(); }

        ReversePoolIt                   rbegin() { return m_framebuffer_pool.rbegin(); }
        ConstReversePoolIt              crbegin() const { return m_framebuffer_pool.crbegin(); }
        ReversePoolIt                   rend() { return m_framebuffer_pool.rend(); }
        ConstReversePoolIt              crend() const { return m_framebuffer_pool.crend(); }
