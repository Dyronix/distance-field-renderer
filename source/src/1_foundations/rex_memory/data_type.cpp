...
namespace rex
{
    ...
    {
        return type == DataType::SAMPLER2D
            || type == DataType::SAMPLER3D
    ...
    {
        return type == DataType::IVEC2
            || type == DataType::IVEC3
            || type == DataType::IVEC4
            || type == DataType::UIVEC2
            || type == DataType::UIVEC3
            || type == DataType::UIVEC4
            || type == DataType::VEC2
            || type == DataType::VEC3
            || type == DataType::VEC4;
    }
